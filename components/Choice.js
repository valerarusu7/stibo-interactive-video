...
function Choice({ question, onClick }) {
  ...
  return (
    <div className="relative h-full ">
      {question === "q1" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop1.mp4")}
      ...
      {question === "q2" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop2.mp4")}
      ...
      {question === "q3" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop3.mp4")}
      ...
      {question === "q6" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop6.mp4")}
      ...
      {question === "q7" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop7.mp4")}
      ...
      {question === "q9" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop9.mp4")}
          choice1="Yes"
          choice2="No"
      ...
      {question === "q10" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop10.mp4")}
      ...
      {question === "q11" ? (
        <ChoiceComponent
          src={require("../assets/videos/loop11.mp4")}
          choice1="Fronted/UX"
